...
namespace GerenciadorCondominios.DAL.Mapeamentos
{
    public class MesMap : IEntityTypeConfiguration<Mes>
    {
        public void Configure(EntityTypeBuilder<Mes> builder)
        {
            ...
            // Chave primaria digitada manualmente
            ...
            builder.HasMany(m => m.Alugueis).WithOne(mbox => mbox.Mes);
            builder.HasMany(m => m.HistoricoRecursos).WithOne(mbox => mbox.Mes);

            // Inserindo os meses no BD
